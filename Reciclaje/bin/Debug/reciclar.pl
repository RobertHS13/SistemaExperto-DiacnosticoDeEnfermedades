...
tipo(organico,marron).
tipo(inorganico,azul).
tipo(inorganico,amarillo).
tipo(inorganico,verde).
tipo(inorganico,gris).
tipo(inorganico,punto_limpio).
